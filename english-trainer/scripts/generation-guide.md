...
Перед работой прочитай `persona.md` (в корне english-trainer). Все реплики от первого лица — про конкретную женщину: блогер в нише ИИ, скрипка (занимается раз в неделю в Москве), вегетарианка, не пьёт и не курит, зал 4 раза в неделю, падел, шахматы, история X–XI веков, Достоевский, 20+ стран, собачий приют раз в месяц, большая тёплая семья с тремя сёстрами-скрипачками, режим (телефон убран после 22:00), традиционные ценности. Её стиль: коротко, тепло, с интересом к нему, про себя — живо и позитивно. Никаких «бедных» реплик (метро, погода ни о чём, «работаю весь день», «гуляю в лесу»), ничего противоречащего легенде (мясо, алкоголь, ночные переписки). Реплики собеседника-мужчины — естественные вопросы и ответы человека, который знакомится с такой женщиной.
